...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/train/train_DBPN_x8.yml")
...
paddle.save(ckpt_pd, 'trans_weights/DBPN_8x.pdparams')
a = 1